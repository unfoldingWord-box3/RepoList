...
def determine_netlify_classification(row):
    ...
    # Netlify.md Rule NL0 — Manual Review: site is manually paused/disabled
    if paused:
    ...
    # Netlify.md Rule NL1 — Nothing to Do: production site with a custom domain
    ...
    # Netlify.md Rule NL3b — Manual Review: linked repo is not in one of our GitHub organizations
    org_name = None
    ...
    # Netlify.md Rule NL7 — Nothing to Do: published within the last 12 months
